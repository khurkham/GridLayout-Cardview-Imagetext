...
public class Fragmenttitle52 extends MyAppFragment {

    public Fragmenttitle52(){
        this.appSection = AppSection.TITLE52;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title52, container, false);
