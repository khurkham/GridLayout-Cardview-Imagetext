...
public class Fragmenttitle621 extends MyAppFragment {

    public Fragmenttitle621(){
        this.appSection = AppSection.TITLE621;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title621, container, false);
