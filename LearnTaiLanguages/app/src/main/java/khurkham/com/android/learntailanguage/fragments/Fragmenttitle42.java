...
public class Fragmenttitle42 extends MyAppFragment {

    public Fragmenttitle42(){
        this.appSection = AppSection.TITLE42;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title42, container, false);
