...
public class Fragmenttitle43 extends MyAppFragment {

    public Fragmenttitle43(){
        this.appSection = AppSection.TITLE43;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title43, container, false);
