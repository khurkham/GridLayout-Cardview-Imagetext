...
public class Fragmenttitle72 extends MyAppFragment {

    public Fragmenttitle72(){
        this.appSection = AppSection.TITLE72;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title72, container, false);
