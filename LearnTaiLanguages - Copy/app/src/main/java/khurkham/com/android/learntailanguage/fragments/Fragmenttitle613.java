...
public class Fragmenttitle613 extends MyAppFragment {

    public Fragmenttitle613(){
        this.appSection = AppSection.TITLE613;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title613, container, false);
