...
public class Fragmenttitle71 extends MyAppFragment {

    public Fragmenttitle71(){
        this.appSection = AppSection.TITLE71;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title71, container, false);
