...
public class Fragmenttitle53 extends MyAppFragment {

    public Fragmenttitle53(){
        this.appSection = AppSection.TITLE53;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title53, container, false);
