...
public class Fragmenttitle12 extends MyAppFragment {

    public Fragmenttitle12(){
        this.appSection = AppSection.TITLE12;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_title12, container, false);
